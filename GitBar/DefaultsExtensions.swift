...
extension Defaults.Keys {
	...
	static let fixedFetchOption = Key<String>("fixedFetchOption", default: "this_month", iCloud: true)
	static let useRollingCount = Key<Bool>("useRollingCount", default: false, iCloud: true)
